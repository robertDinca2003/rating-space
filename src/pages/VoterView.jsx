...
const VoteView = () => {
    ...
    return (
        <div className="text-white min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black  flex flex-col gap-10 py-32 items-center">
            <h1 className="text-3xl xxsm:text-4xl xsm:text-6xl sm:text-7xl outline-text">Voting Space</h1>
            <p className="text-2xl xxsm:text-3xl">{question}</p>
            <div className="grid grid-cols-1 xxsm:grid-cols-2 content-center  gap-5">
            ...
            <h2 className="text-xl xxsm:text-2xl xsm:text-3xl">Vote {myVote} is selected</h2>
    ...
    return(
        <div className="text-white min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black  flex flex-col gap-10 py-32 items-center">
            <h1 className="text-2xl xxsm:text-3xl xsm:text-4xl">Waiting for the host</h1>
            <h2 className="text-xl xxsm:text-2xl">Connected to room: {roomId}</h2>
        </div>
    )
}
